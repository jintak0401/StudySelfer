...
export default ({ navigation, route }) => {
  ...
  // const [afterChanged, setAfterChanged] = useState({
  //   1: false,
  //   2: false,
  //   3: false,
  //   4: false,
  ...
  // const removingAns = (ansNum) => {
  //   const tmp = { ...removedAns };
  //   if (!(questNum in tmp)) tmp[questNum] = {};
  //   const alreadyRemoved = tmp[questNum][ansNum];
  //   tmp[questNum][ansNum] = !alreadyRemoved;
  //   setRemovedAns({ ...tmp });
  // };
  ...
  const changeQuestNum = (num) => {
    setQuestNum(num);
    // if (1 <= num && num <= 21)
    // setAfterChanged({ 1: true, 2: true, 3: true, 4: true, 5: true });
  };
        ...
        <AnsbtnSet>
          {[1, 2, 3, 4, 5].map((n) => (
            <Ansbtn
              ...
              selectAns={selectAns}
              // afterChanged={afterChanged[n]}
              // setAfterChanged={setAfterChanged}
              // removed={removedAns[questNum]?.[n]}
